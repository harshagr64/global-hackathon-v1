...
export const PREDEFINED_QUESTS: MemoryQuest[] = [
  {
    ...
    description: 'Journey back to your teenage years and share the memories that shaped you for your grandchildren',
    icon: '🎓',
  ...
  },
  {
    ...
    description: 'Share stories about your early working life and career beginnings with your grandchildren',
    icon: '💼',
  ...
  },
  {
    ...
    description: 'Tell your grandchildren about creating a home and the precious memories within those walls',
    icon: '🏠',
  ...
  },
  {
    ...
    description: 'Share the romantic journey that brought you together with your partner for your grandchildren to know',
    icon: '❤️',
